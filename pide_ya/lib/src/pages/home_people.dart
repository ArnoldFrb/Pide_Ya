                        ...
                        children: [
                          Expanded(
                            child: ListTile(
                              ...
                              title: Text(widget.user.isEmpty ? 'NULL' : snapshot.data.displayName),
                              subtitle: Text(widget.user.isEmpty ? 'NULL' : snapshot.data.direction),
                              onTap: () {
                                    ...
                                    children: [
                                      Expanded(
                                        child: IconButton(
                                          ...
                                          onPressed: () {
                                            Navigator.pushNamed(context, DirectionPage.ROUTE);
                                          }
                                        )
                                      ),
                                      Expanded(
                                    ...
                                    children: [
                                      Expanded(
                                        child: IconButton(
                                          ...
                                          onPressed: () {
                                            Navigator.pushNamed(context, AskForPage.ROUTE);
                                          }
                                        )
                                      ),
                                      Expanded(
                  ...
                  if(snapshot.hasData){
                    return ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index){
                        ...
                        return _listStore(context, store.displayName, store.direction, store.photoURL);
                      },
                    );
                  }else if(snapshot.hasError){
...
Widget _listStore(context, String displayName, String direction, String photoUrl){
  return Card(
    shape: RoundedRectangleBorder(
      borderRadius: BorderRadius.circular(10.0),
    ),
        ...
        Expanded(
          ...
          child: Container(
            ...
            child: ListTile(
              ...
              trailing: IconButton(
                onPressed: () {
                  Navigator.pushNamed(context, VStorePage.ROUTE);
                },
